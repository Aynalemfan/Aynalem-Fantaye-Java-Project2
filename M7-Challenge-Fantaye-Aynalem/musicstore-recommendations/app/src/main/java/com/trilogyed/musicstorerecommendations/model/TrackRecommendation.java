...
public class TrackRecommendation {
    ...
    public TrackRecommendation(Long trackRecommendationId,int trackId,int userId,boolean liked) {
    ...
    public boolean equals(Object o) {
        ...
        return getTrackId() == that.getTrackId() && getUserId() == that.getUserId() && isLiked() == that.isLiked() && Objects.equals(getTrackRecommendationId(),that.getTrackRecommendationId());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getTrackRecommendationId(),getTrackId(),getUserId(),isLiked());
    }
